...
RUN apt-get update
RUN apt-get install nginx php7.1 supervisor php7.1-fpm php7.1-xdebug php7.1-json php7.1-curl php7.1-redis php7.1-memcache php7.1-mysql php7.1-curl php7.1-mcrypt php7.1-soap php7.1-gd php7.1-gmp php7.1-intl php7.1-mbstring php7.1-phalcon -y --allow-unauthenticated
...
RUN phpenmod redis json curl memcache mysqli opcache pdo pdo_mysql readline xdebug intl mbstring phalcon
